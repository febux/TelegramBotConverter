...
class Command(object):
    ...
    def __init__(self, func=None):
        ...
        kwargs = dict(izip(*[reversed(kw) for kw in (args, defaults)]))
...
class Shell(Command):
    ...
    def __init__(self, banner=None, make_context=None, use_ipython=True, use_bpython=True, use_ptipython=True,
                 use_ptpython=True):
...
class Server(Command):
    ...
    def __init__(self, host='127.0.0.1', port=5000, use_debugger=None, use_reloader=None, threaded=False, processes=1,
